...
// Identical clinical logic to the web app's demo-data.ts
...
export type AlertStatus = 'info' | 'working' | 'flag' | 'critical' | 'ok';
export type Tone =
  | 'brand'
  | 'red'
  | 'amber'
...
export const AGENTS: AgentMeta[] = [
  ...
  },
  {
    ...
    name: 'Completeness',
    nameBn: 'সম্পূর্ণতা',
    role: 'Surfaces guideline-recommended questions the doctor has not asked yet.',
    tone: 'sky',
  },
  {
    key: 'danger',
  ...
  },
  {
    ...
    nameBn: 'রোগীর সারাংশ',
    role: 'Plain-Bangla, spoken record for the patient.',
    tone: 'emerald',
  },
];
...
// ---------------------------------------------------------------------------
// Consultation transcript (dual-mic fused)
// ---------------------------------------------------------------------------
export const TRANSCRIPT: TranscriptLine[] = [
  {
    ...
    en: 'Hello, please sit. What is wrong with the child?',
    conf: 0.95,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    en: 'Yes, cough. He will not eat, and his chest pulls in when he breathes.',
    conf: 0.66,
    fused: true,
  },
  {
...
export const AGENT_EVENTS: AgentEvent[] = [
  ...
  },
  {
    ...
    detail:
      'Fast-breathing threshold for 1–5 years is ≥ 40/min. Awaiting a measured rate.',
    status: 'working',
  ...
  },
  {
    ...
    afterLine: 6,
    agent: 'scribe',
    title: 'Extracted: cough, poor feeding, chest indrawing',
  ...
  },
  {
    ...
    detail:
      'Ranked from fever + cough + fast breathing + indrawing, with asthma history on file.',
    status: 'info',
  ...
  },
  {
    ...
    detail:
      'RR 52 ≥ 40/min (age 1–5y) AND lower chest indrawing → SEVERE PNEUMONIA → urgent referral.',
    status: 'critical',
    citation: {
      source: 'WHO IMCI',
      ref: 'Classify: severe pneumonia / very severe disease',
    },
  },
  {
    id: 8,
  ...
  },
  {
    ...
    afterLine: 9,
    agent: 'medsafety',
    title: '⚠️ CONTRAINDICATION — Amoxicillin blocked',
    detail:
      'Amoxicillin is a penicillin-class drug; patient record lists a Penicillin allergy.',
    status: 'critical',
    citation: {
      source: 'BNF / NDF Bangladesh',
      ref: 'Amoxicillin — penicillin hypersensitivity',
    },
  },
  {
    id: 10,
    afterLine: 9,
    agent: 'summary',
    title: 'Drafting patient Bangla record',
    detail:
      'Plain-language summary + danger signs, ready to read aloud on the patient phone.',
    status: 'info',
  },
];

// ---------------------------------------------------------------------------
// Deterministic alert cards
// ---------------------------------------------------------------------------
export const DANGER_ALERT = {
  ...
  citation: {
    ...
    ref: 'Cough or difficult breathing → classify',
  },
};
...
export const MEDSAFETY_ALERT = {
  ...
  alternative:
    'Use a non-penicillin agent per the severe-pneumonia referral protocol. Confirm at the referral facility.',
  citation: {
    source: 'National Drug Formulary (BD) / BNF',
    ref: 'Amoxicillin — contraindicated in penicillin hypersensitivity',
  },
};

// ---------------------------------------------------------------------------
// SOAP note (auto-drafted; doctor confirms with one tap)
// ---------------------------------------------------------------------------
...
export const PATIENT_SUMMARY = {
  ...
  meaningEn: 'Fast breathing and chest indrawing are danger signs. Do not delay.',
  ...
  citations: [
    { source: 'WHO IMCI chart booklet', ref: 'Classify: severe pneumonia' },
    { source: 'NDF Bangladesh', ref: 'Amoxicillin — penicillin hypersensitivity' },
  ],
  tone: 'red' as 'red' | 'amber' | 'brand',
  refer: true,
};
...
export const PROBLEM_STATS = [
  ...
  { value: 'Bangla-only', label: 'patients handed English meds they cannot read' },
];
...
export const HOW_IT_WORKS = [
  {
    step: '01',
    title: 'Scan the QR',
    desc: 'The patient scans the code on the doctor door; their record loads instantly.',
  },
  {
    step: '02',
